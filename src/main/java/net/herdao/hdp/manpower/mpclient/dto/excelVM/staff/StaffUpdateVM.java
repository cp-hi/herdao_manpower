...
public class StaffUpdateVM {
    ...
    @ExcelProperty(value = "移动电话", index = 4)
    ...
    @ExcelProperty(value = "人员归属范围", index = 8)
    @ApiModelProperty(value="人员归属范围")
    private String staffScope;

    @ExcelProperty(value = "任职类型", index = 9)
    @ApiModelProperty(value="任职类型")
    private String jobType;

    @ExcelProperty(value = "劳动合同签订主体", index = 10)
